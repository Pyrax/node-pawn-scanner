...
root.scanPawnCode = function (filename, code, options, intel) {
  options = options || {};
  ...
  var item = intel.push(structure)-1;
  ...
  while ((match = reFunction.exec(code))) {
    ...
    intel[item].functions.push(info);
  }
...
if (typeof exports !== 'undefined' && root.exports !== exports) {
  ...
  root.scanFile = function (filename, options, intel) {
    ...
    return root.scanPawnCode(filename, code, options, intel);
  }
